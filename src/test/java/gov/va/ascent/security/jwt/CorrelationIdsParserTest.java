...
public class CorrelationIdsParserTest {
	...
	public void testParseCorrelationIds() {
		...
		String patientId = "1020212383V608753^NI^200M^USVHA^P,100001412^PI^200BRLS^USVBA^A,20120203003^PI^200CORP^USVBA^A,1025062341^NI^200DOD^USDOD^A,123456789^SS";
		CorrelationIdsParser instance = new CorrelationIdsParser();
		Map<String, String> result = instance.parseCorrelationIds(patientId);
	...
	public void testParseCorrelationIds1() {
		CorrelationIdsParser instance = new CorrelationIdsParser();
		String patientId = "1020212383V608753^NI^200M^USVHA^P,100001412^PI^200BRLS^USVBA^A,20120203003^PI^200CORP^USVBA^A,1025062341^NI^200DOD^USDOD^A,12345678903^SS^200CORP^USVBA^A";
		Map<String, String> result = instance.parseCorrelationIds(patientId);
		assertTrue(result.get("icn").equals("1020212383V608753"));
	...
	public void testParseCorrelationIds2() {
		CorrelationIdsParser instance = new CorrelationIdsParser();
		String patientId = "100001412^PI^553^USVHA^A,1020212383V608753^NI^200M^USVHA^P,1025062341^NI^200DOD^USDOD^A,20120203003^PI^500^USVHA^A,123456789^SS";
		Map<String, String> result = instance.parseCorrelationIds(patientId);
		assertTrue(result.get("icn").equals("1020212383V608753"));
		assertTrue(result.get("pnid").equals("123456789"));
		assertTrue(result.get("pnidType").equals("SS"));
	...
	public void testParseCorrelationIds3() {
		CorrelationIdsParser instance = new CorrelationIdsParser();
		String patientId = "12345678903^XX^200CORP^USVBA^A,1020212383V608753^NI^200M^USVHA^P,100001412^PI^200BRLS^USVBA^A,20120203003^PI^200CORP^USVBA^A,1025062341^NI^200DOD^USDOD^A";
		Map<String, String> result = instance.parseCorrelationIds(patientId);
		assertTrue(result.get("icn").equals("1020212383V608753"));
	...
	public void testParseCorrelationIds4() {
		System.out.println("processMainToken");
		String patientId = "1020212383V608753^NI^200M^USVBA^P,100001412^MI^200BRLS^USVBA^A,20120203003^MI^200CORP^USVBA^A,1025062341^PI^200DOD^USDOD^A,123456789^XX";
		CorrelationIdsParser instance = new CorrelationIdsParser();
		Map<String, String> result = instance.parseCorrelationIds(patientId);
